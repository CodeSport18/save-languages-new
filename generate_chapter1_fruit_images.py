...
SLIDE_PROMPTS: list[tuple[int, str]] = [
    ...
    (
        2,
        "A single ripe yellow banana on a clean white background, photorealistic, studio lighting, centered composition",
    ),
    (
        3,
        "A bunch of purple grapes on a clean white background, photorealistic, studio lighting, centered composition",
    ),
    (
        4,
        "A single whole orange fruit on a clean white background, photorealistic, studio lighting, centered composition",
    ),
    (
        5,
        "A single ripe red strawberry on a clean white background, photorealistic, studio lighting, centered composition",
    ),
    (
        6,
        "A single whole watermelon on a clean white background, photorealistic, studio lighting, centered composition",
    ),
    (
        7,
        "A single ripe mango fruit on a clean white background, photorealistic, studio lighting, centered composition",
    ),
    (
        8,
        "A single ripe peach fruit on a clean white background, photorealistic, studio lighting, centered composition",
    ),
    (
        9,
        "A single whole pineapple on a clean white background, photorealistic, studio lighting, centered composition",
    ),
    (
        10,
        "A single bright green pear on a clean white background, photorealistic, studio lighting, centered composition",
    ),
    (
        11,
        "Three different fruits arranged together: an apple, a banana, and an orange on a white background, photorealistic",
    ),
]
